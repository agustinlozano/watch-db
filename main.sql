...
CREATE TABLE `Case` (
  ...
  `id_pusher` INTEGER NULL DEFAULT NULL,
...
CREATE TABLE `Clasp` (
  ...
  `clap_type` MEDIUMTEXT NULL DEFAULT NULL,
...
CREATE TABLE `Caseback` (
  ...
  `id_shape` INTEGER NULL DEFAULT NULL,
  `id_caseback_design` INTEGER NULL DEFAULT NULL,
...
CREATE TABLE `Movement` (
  ...
  `battery_life` INTEGER NULL DEFAULT NULL,
...
CREATE TABLE `Basic_info` (
  ...
  `id_manufactured_in` INTEGER NULL DEFAULT NULL,
...
-- ---
-- Table 'Manufactured_in'
-- 
-- ---

DROP TABLE IF EXISTS `Manufactured_in`;
...
CREATE TABLE `Style` (
  ...
  `style_name` MEDIUMTEXT NULL DEFAULT NULL,
...
CREATE TABLE `Length_unit` (
  ...
  `unit_name` MEDIUMTEXT NULL DEFAULT NULL,
...
CREATE TABLE `Complication` (
  ...
  `id_complication_function` INTEGER NULL DEFAULT NULL,
...
CREATE TABLE `Complication_type` (
  ...
  `id_complication_name` MEDIUMTEXT NULL DEFAULT NULL,
...
-- ---
-- Table 'Complication_function'
-- 
-- ---

DROP TABLE IF EXISTS `Complication_function`;
		
CREATE TABLE `Complication_function` (
  `id_complication_function` INTEGER NULL AUTO_INCREMENT DEFAULT NULL,
  `complication_function_name` MEDIUMTEXT NULL DEFAULT NULL,
  PRIMARY KEY (`id_complication_function`)
);
...
CREATE TABLE `Crown_function` (
  ...
  `crown_function_name` MEDIUMTEXT NULL DEFAULT NULL,
...
ALTER TABLE `Case` ADD FOREIGN KEY (id_pusher) REFERENCES `Pusher` (`id_pusher`);
...
ALTER TABLE `Caseback` ADD FOREIGN KEY (id_caseback_design) REFERENCES `Backcase_design` (`id_backcase_design`);
...
ALTER TABLE `Basic_info` ADD FOREIGN KEY (id_manufactured_in) REFERENCES `Manufactured_in` (`id_country`);
...
ALTER TABLE `Complication` ADD FOREIGN KEY (id_complication_function) REFERENCES `Complication_function` (`id_complication_function`);
...
-- ALTER TABLE `Manufactured_in` ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
-- ALTER TABLE `Complication_function` ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
-- INSERT INTO `Case` (`id_case`,`id_crystal`,`id_material`,`id_color`,`id_pusher`,`id_shape`) VALUES
-- ('','','','','','');
...
-- ('','');
-- INSERT INTO `Clasp` (`id_clasp`,`clap_type`) VALUES
-- ('','');
-- INSERT INTO `Caseback` (`id_caseback`,`id_shape`,`id_caseback_design`,`id_opening_system`,`id_material`) VALUES
-- ('','','','','');
...
-- ('','');
-- INSERT INTO `Movement` (`id_movement`,`id_owner`,`id_movement_type`,`id_battery`,`battery_life`) VALUES
-- ('','','','','');
...
-- ('','');
-- INSERT INTO `Basic_info` (`id_info`,`id_manufactured_in`,`id_brand`,`id_style`,`id_gender`,`water_resistance`) VALUES
-- ('','','','','','');
-- INSERT INTO `Brand` (`id_brand`,`brand_name`) VALUES
-- ('','');
-- INSERT INTO `Manufactured_in` (`id_country`,`country_name`) VALUES
-- ('','');
...
-- ('','');
-- INSERT INTO `Length_unit` (`id_length_unit`,`unit_name`) VALUES
-- ('','');
-- INSERT INTO `Complication` (`id_complication`,`id_complication_type`,`id_complication_function`) VALUES
-- ('','','');
-- INSERT INTO `Complication_type` (`id_complication_type`,`id_complication_name`) VALUES
-- ('','');
-- INSERT INTO `Crown` (`id_crown`,`id_crown_type`,`id_crown_function`) VALUES
-- ('','','');
-- INSERT INTO `Complication_function` (`id_complication_function`,`complication_function_name`) VALUES
-- ('','');
-- INSERT INTO `Crown_type` (`id_crown_type`,`crown_name`) VALUES
-- ('','');
-- INSERT INTO `Crown_function` (`id_crown_function`,`crown_function_name`) VALUES
-- ('','');